...
/**
 * Generate route parameter objects for each article so Next.js can pre-render their pages.
 *
 * @returns An array of route parameter objects with a `slug` property for each article
 */
...
/**
 * Convert lightweight markdown-like text into HTML.
 *
 ...
 * @returns The input text with the supported markup transformed into HTML
 */
