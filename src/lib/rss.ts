 ...
 *
 * @param content - Input string containing Markdown or HTML-like markup
 * @returns A plain-text string with formatting removed (e.g., code blocks, inline code, bold markers, headers, and link markup), consecutive newlines collapsed to spaces, trimmed, and limited to at most 500 characters
 */
