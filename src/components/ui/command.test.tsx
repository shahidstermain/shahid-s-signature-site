...
describe("command components", () => {
  ...
  describe("edge cases", () => {
    ...
    it("should maintain accessibility with keyboard shortcuts", () => {
      render(
        <Command>
          <CommandInput placeholder="Search..." />
          <CommandList>
      ...
      // Shortcut should be visible for user reference
      expect(screen.getByText("⌘S")).toBeInTheDocument();
    });

    it("should handle command palette with search and results", () => {
      render(
        <Command>
          ...
          <CommandList>
            ...
            <CommandGroup heading="Files">
              <CommandItem>file1.ts</CommandItem>
              <CommandItem>file2.ts</CommandItem>
            </CommandGroup>
          </CommandList>
        </Command>
      );
